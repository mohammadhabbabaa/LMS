...
namespace Kurs.Controllers.Teachers
{
    ...
    public class TeachersController : Controller
    {
        ...
        public ActionResult Index(int? page ,string search)
        {
                ...
                var users = db.Users.Include(u => u.Role).Where(e => e.Active == 1).Where(e => e.UserTaype == 2).Where(e => e.Name.StartsWith(search)||search==null).OrderByDescending(e => e.ID);
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Emial,Birthday,Address,Phone,API_KEY,API_SECRET")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Emial,Birthday,Address,Phone,API_KEY,API_SECRET")] User user)
        {
            if (ModelState.IsValid)
            {
                ...
                myuser.API_KEY = user.API_KEY;
                myuser.API_SECRET = user.API_SECRET;
